...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
		...
		self.textLabel.textColor = [UIColor whiteColor];//[UIColor colorWithRed:0.4 green:0.4 blue:0.4 alpha:1.0];
		...
		self.customTextLabel.textColor = [UIColor whiteColor];//[UIColor colorWithRed:0.4 green:0.4 blue:0.4 alpha:1.0];
