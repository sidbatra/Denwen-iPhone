...
- (void)viewDidLoad {
	...
	theCoordinate.latitude = 37.4261215336733;
    theCoordinate.longitude = -122.1586561203003;
	...
	MKCoordinateRegion region = MKCoordinateRegionMakeWithDistance(theCoordinate, 500, 500);
